...
typedef struct {
    char* file_name;            /* Το όνομα του αρχείου*/                    
    int max_records_in_a_block;      /* Ο μέγιστος αριθμός εγγραφών που μπορεί να έχει ένα block*/
    int last_block_id;          /* Το id του τελευταίου block στο αρχείο*/
    int num_of_last_block_records;     /* Αριθμός εγγραφών στο τελευταίο block του αρχείου*/
